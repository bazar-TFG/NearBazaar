...
const App = () => {
    ...
    return (
        ...
        <div className='container-sm mt-5' id="principal">
                <Routes>
                    <Route path="/inbz" element={<FormBazaar />}></Route>
                    <Route path="/upbz" element={<UpdateBazaar />}></Route>
        ...
        <footer className="navbar fixed-bottom navbar-dark" id="footer">
        <div className="text-dark justify-content-center container-sm">¿Tienes sugerencias? Contacta</div>
          <div className="justify-content-evenly container-sm">
          ...
          <div className="text-dark justify-content-center container-sm">
                © 2022 Copyright
            </div>
        </footer>
